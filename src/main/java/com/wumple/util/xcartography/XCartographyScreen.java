...
{
	private static final ResourceLocation CONTAINER_TEXTURE = new ResourceLocation("minecraft",
	...
	private void drawMap(@Nullable MapData mapDataIn, boolean isMap, boolean isPaper, boolean isGlassPane,
			boolean isLocked)
	{
		int i = this.guiLeft;
		int j = this.guiTop;
